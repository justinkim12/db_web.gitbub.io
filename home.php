...
$sql = "select f_name,l_name,20_21,conference from team_info inner join team_regular on team_info.team_id=team_regular.team_id order by 20_21 desc";
            ...
            <div class="container">
                ...
                <section id="cont_left">
                    ...
                    <article class="column col1">
						...
						<div class="menu">
                            ...
                            <?php
                                ...
                                <li><a href="<?php echo $_SESSION['f_team_id'];?>.php?year=16_17">Favorite Team <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
								<li><a href="player.php?f_name=<?php echo $_SESSION['f_player_f_name'];?>&l_name=<?php echo $_SESSION['f_player_l_name'];?>">Favorite Player <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
                                ...
                                ?>
                                    <li class="nav-item">
                                        <a class="nav-link active" aria-current="page" href="signup.php">SIGNIN </a>
                                    </li>
                    ...
                    <article class="column col2">
                        <h4 class="col_tit">East Conference</h4>       
						<p class="col_desc">Rank</p>
						<table > 
                                <tr>
                                    <th>Team</th>
                                    <th>W</th>
                                ...
                                <?php foreach ($articles as $article) {?>
                                    <?php if($article['conference']=='E'){?>
                                    <tr>
                                        <th><?= $article['f_name']?> <?= $article['l_name']?></th>
                                        <th><?= $article['20_21']?></th>
                                        <th><?= 72- $article['20_21']?></th>
                                    </tr>
                    ...
                    <article class="column col3">
                        <h4 class="col_tit">West Conference</h4>
						<p class="col_desc">Rank</p>
						<table > 
                                <tr>
                                    <th>Team</th>
                ...
                <section id="cont_center">
                    ...
                    <article class="column col6">
                        <h4 class="col_tit">Playoff Tournament</h4>
...
$(document).ready(function(){
	...
	$.ajax({
			...
			success:function(data)
			{
				...
				{
					team_id.push(data[count].team_id);
