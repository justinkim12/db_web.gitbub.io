...
$sql = "select * from player_info 
        inner join player_awards 
        on player_info.player_id=player_awards.player_id  
        where f_name='$f'and l_name='$l';";
...
<head>
    ...
    <style>
        ...
        .title .search {font-family: 'Nanum Brush Script', cursive; font-size: 19px; color: #0093bd; padding: 25px 0;}
        input{          width: 30%;
		...
		<div class="container">
            ...
            <div class="form-group">
						<select name="selectbox" id="selectbox" >
							...
							<option value="17_18">17-18</option>
							<option value="18_19">18-19</option>
							<option value="19_20">19-20</option>
							<option value="20_21">20-21</option>
						</select>
                            
                        <input type="text" name="search" id='search' placeholder="player firstname">
						<input type="text" name="search2" id='search2' placeholder="player lastname">
            ...
            <div class="container">
                ...
                <section id="cont_left">
                    ...
                    <article class="column col1">
                        <h4 class="col_tit" id='player_tit'>                        
                            <script>
                                const params= new URLSearchParams(location.search);
                                
                                //alert(params);
                                if(params.get('f_name')){
                                    document.write(params.get('f_name'));
                                    document.write(' ');
                                    document.write(params.get('l_name'));}
                                else{
                                    docment.write('Search Player');
                                }
						...
						<p class="col_desc" id='player_ex'>Box-shadow를 이용한 마우스 오버 효과 메뉴입니다.</p>
						<!-- 메뉴 -->
						<div class="menu">
							<ul>
								<li><a href="?f_name=<?php echo $_GET['f_name'];?>&l_name=<?php echo $_GET['l_name'];?>&season=16_17">16-17 <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
								<li><a href="?f_name=<?php echo $_GET['f_name'];?>&l_name=<?php echo $_GET['l_name'];?>&season=17_18">17-18 <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
								<li><a href="?f_name=<?php echo $_GET['f_name'];?>&l_name=<?php echo $_GET['l_name'];?>&season=18_19">18-19 <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
								<li><a href="?f_name=<?php echo $_GET['f_name'];?>&l_name=<?php echo $_GET['l_name'];?>&season=19_20">19-20 <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
								<li><a href="?f_name=<?php echo $_GET['f_name'];?>&l_name=<?php echo $_GET['l_name'];?>&season=20_21">20-21 <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
                    ...
                    <article class="column col2">
						...
						<table > 
                                ...
                                <?php foreach ($articles as $article) {?>
                                    ...
                                    <tr>
                                        <th><?= $article['season_year']?></th>
                                        <th><?= $article['award_type']?></th>
                ...
                <section id="cont_center">
                    ...
                    <article class="column col4">
                        <h4 class="col_tit">Team Avg Point</h4>
                    ...
                    <article class="column col5">
                        <h4 class="col_tit">Team Avg Rebound</h4>
						<p class="col_desc">이 곳은 설명 부분입니다.</p>
                        <div class="chart-container pie-chart">
                ...
                <section id="cont_right">
                    ...
                    <article class="column col7">
                        <h4 class="col_tit">Team Average Assist</h4>
						<p class="col_desc">이 곳은 설명 부분입니다.</p>
                        <div class="chart-container pie-chart">
                    ...
                    <article class="column col8">
                        <h4 class="col_tit">Team Average Block</h4>
						<p class="col_desc">이 곳은 설명 부분입니다.</p>
                        <div class="chart-container pie-chart">
                    ...
                    <article class="column col9">
                        <h4 class="col_tit">Team Average Steal</h4>
						<p class="col_desc">이 곳은 설명 부분입니다.</p>
                        <div class="chart-container pie-chart">
...
$(document).ready(function(){
    if(params){
        var language =params.get('f_name');
        var language2 =params.get('l_name');
        var year=['16_17','17_18','18_19','19_20','20_21'];
        var category='16_17';
        $.ajax({
			url:"player_data.php",
			method:"POST",
			data:{action:'search', language:language, language2: language2},
			...
			success:function(data)
			{
				...
				if(data){
                    if(params.get('season'))
                            category=params.get('season');
                    
                    for (var i = 0; i <= year.length+1; i++) {


                        if(category=='16_17'){
                            season='game_date>=\'16-10-25\' and game_date<=\'17-4-15\'';
                            // alert(language2);
                        }
                        if(category=='17_18'){
                            season='game_date>=\'17-10-17\' and game_date<=\'18-4-14\'';
                            // alert(language2);
                        }
                        if(category=='18_19'){
                            season='game_date>=\'18-10-16\' and game_date<=\'19-4-13\'';
                            // alert(language2);
                        }
                        if(category=='19_20'){
                            season='game_date>=\'16-10-22\' and game_date<=\'20-8-15\'';
                            // alert(language2);
                        }
                        if(category=='20_21'){
                            season='game_date>=\'20-12-22\' and game_date<=\'21-5-18\'';
                            // alert(language2);
                        }
                        if(check(data,season)){

                                makechart(data,season);
                                break;
                                }
                        if(i==0){
                            if(params.get('season'))
                                alert('No Season Data');
                            }
                        if(i>0)
                            category=year[i-1];
                    ...
                    // alert(check(data,season));

					document.getElementById("player_tit").innerText=language+' '+language2;
                    document.getElementById("player_ex").innerText=category+' Season';
	...
	// category=chageLangSelect();
	$('#submit_data').click(function(){
        
		var language = $('#search').val();
		var language2= $('#search2').val();
		var langSelect = document.getElementById("selectbox");
		var category =  langSelect.options[langSelect.selectedIndex].value;
		$.ajax({
			url:"player_data.php",
			method:"POST",
			data:{action:'search', language:language, language2: language2},
			...
			success:function(data)
			{
				...
				if(data){
					...
					document.getElementById("player_tit").innerText=language+' '+language2;
                    document.getElementById("player_ex").innerText=category+' Season';
                    window.open(location.pathname+'?f_name='+language+'&l_name='+language2);
                    // alert(location.pathname+'?f_name='+language+'&l_name='+language2);
					if(check(data,season))
                        makechart(data,season);
                    else
                        alert('No Player Data');
...
//	makechart();
	function makechart(id_num,category)
	{
        var a=false;
		$.ajax({
			...
			method:"POST",
            async:false,
			data:{action:'fetch',id:id_num,category:category},
			dataType:"JSON",
			success:function(data)
			{
				var month = [];
    ...
    function check(id_num,category)
	{
        var a=false;
		$.ajax({
			url:"player_data.php",
